...
This issue tracker is only for technical issues related to Zond Core.
General Zond questions and/or support requests and are best directed to the [Zond Slack](http://zond.slack.com).
...
### What version of Zond Core are you using?
