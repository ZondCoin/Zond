...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zond features */
        {"zond", "masternode", &masternode, true, true, false},
        {"zond", "listmasternodes", &listmasternodes, true, true, false},
        {"zond", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zond", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zond", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zond", "masternodedebug", &masternodedebug, true, true, false},
        {"zond", "startmasternode", &startmasternode, true, true, false},
        {"zond", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zond", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zond", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zond", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zond", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zond", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zond", "mnbudget", &mnbudget, true, true, false},
        {"zond", "preparebudget", &preparebudget, true, true, false},
        {"zond", "submitbudget", &submitbudget, true, true, false},
        {"zond", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zond", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zond", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zond", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zond", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zond", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zond", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zond", "checkbudgets", &checkbudgets, true, true, false},
        {"zond", "mnsync", &mnsync, true, true, false},
        {"zond", "spork", &spork, true, true, false},
        {"zond", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zond", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zondd, or the -server option to zond-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zond-cli " + methodname + " " + args + "\n";
}
