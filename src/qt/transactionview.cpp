                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received ZND from zZND"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zZND"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zZND));
