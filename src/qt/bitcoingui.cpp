                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zond Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zond address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zond: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zond Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zond Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zond"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zond addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zond addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zond: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zond Core help message to get a list with possible Zond command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zond Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zond network", "", count));
}
...
{
    QString strTitle = tr("Zond Core"); // default title
