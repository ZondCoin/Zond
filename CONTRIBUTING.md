Contributing to Zond Core
============================

The Zond Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zond Core project, and is not to be
confused with overall Zond Network Protocol consensus changes.

Whether a pull request is merged into Zond Core rests with the project merge
...
Patches that change Zond consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zond consensus, it must have been
...
The project leader is the release manager for each Zond Core release.
