...
RESOURCES += src/qt/zond.qrc src/qt/zond_locale.qrc

TRANSLATIONS += src/qt/locale/zond_bg.ts \
                src/qt/locale/zond_de.ts \
                src/qt/locale/zond_en.ts \
                src/qt/locale/zond_es.ts \
                src/qt/locale/zond_fi.ts \
                src/qt/locale/zond_fr.ts \
                src/qt/locale/zond_it.ts \
                src/qt/locale/zond_ja.ts \
                src/qt/locale/zond_pl.ts \
                src/qt/locale/zond_pt.ts \
                src/qt/locale/zond_ru.ts \
                src/qt/locale/zond_sk.ts \
                src/qt/locale/zond_sv.ts \
                src/qt/locale/zond_vi.ts \
                src/qt/locale/zond_zh_CN.ts \
                src/qt/locale/zond_zh_TW.ts
