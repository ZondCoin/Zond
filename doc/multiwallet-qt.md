...
In order to support loading of multiple wallets in zond-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zond.cpp.
...
Changes to zond.cpp
----------------------
zond.cpp is the entry point into zond-qt, and as such, will require some minor modifications to provide hooks for
